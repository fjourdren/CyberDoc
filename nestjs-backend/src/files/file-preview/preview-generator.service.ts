...
import { unlink as _unlink, readFile as _readFile, writeFile as _writeFile } from "fs";
...
export class PreviewGenerator {
    ...
    async generatePngPreview(file: File, fileContent: Buffer): Promise<Buffer> {
        ...
        // create readable
        return await sharp(contentOutputFile).resize({ width: 300, height: 200 }).png().toBuffer();
    }
}