...
import { SettingsSecurityComponent, SettingsSecurityDialogComponent, SettingsSecurityDevicesDialogComponent } from './components/settings/settings-security/settings-security.component';
